...
urlpatterns = [
    ...
    path('temperature/zielona_gora', views.temperature_zielonga_gora, name='zielona-gora'),
    ...
    path('temperature2/zielona_gora', views.temperature_combined, name='zielona-gora2'),
